...
InvF5All(p, t) ==   /\ F[u_F[p]].bit = 0
                    ...
                    /\ b_F[p].bit = 1 => t.sigma[a_F[p].parent] = a_F[p].parent
...
InvU5All(p, t) ==   /\ SameRoot(t, t.arg[p][1], u_U[p])   
                    ...
                    /\ a_U[p].bit = 1 => t.sigma[u_U[p]] = u_U[p]
...
InvU6All(p, t) ==   /\ SameRoot(t, t.arg[p][1], u_U[p])   
                    ...
                    /\ b_U[p].bit = 1 => t.sigma[v_U[p]] = v_U[p]
...
\* Last modified Wed Apr 23 14:43:26 EDT 2025 by karunram
