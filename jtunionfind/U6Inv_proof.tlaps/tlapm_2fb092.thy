...
theory tlapm_2fb092 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
lemma ob'232: (* 4532f2aa355d57b0d061b7ac74de4ad4 *)
...
shows "(((((fapply ((fapply (((a_aunde_Uhash_primea :: c)), (a_punde_1a))), (''bit''))) = ((0)))) \<Rightarrow> ((SameRoot ((t), (fapply ((fapply (((a_aunde_Uhash_primea :: c)), (a_punde_1a))), (''parent''))), (fapply (((a_uunde_Uhash_primea :: c)), (a_punde_1a))))))))"(is "PROP ?ob'232")
proof -
show "PROP ?ob'232"
using assms by auto
qed
