...
theory tlapm_dcaa4c imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
lemma ob'231: (* 444698d83e405c2553c1ec861aa5a405 *)
...
assumes v'106: "((a_U6a ((p))))"
assumes v'109: "((((a_hef12f5554781c2213604492856f635a :: c)) \<and> (TypeOK)))"
assumes v'110: "(((fapply ((pc), (p))) = (''U6'')))"
assumes v'117: "((((((a_Fhash_primea :: c)) = ([(F) EXCEPT ![(fapply ((a_uunde_Ua), (p)))] = (((''parent'' :> (fapply ((a_vunde_Ua), (p)))) @@ (''rank'' :> (fapply ((fapply ((a_aunde_Ua), (p))), (''rank'')))) @@ (''bit'' :> ((0)))))]))) & ((((a_Mhash_primea :: c)) = (subsetOf(([''sigma'' : (StateSet), ''ret'' : ([(PROCESSES) \<rightarrow> (((((NodeSet) \<union> ({(BOT)}))) \<union> ({(ACK)})))]), ''op'' : (OpSet), ''arg'' : (ArgSet)]), %t. (\<exists> told \<in> (M) : (((((fapply ((fapply ((told), (''ret''))), (p))) = (BOT))) & (((fapply ((t), (''ret''))) = ([(fapply ((told), (''ret''))) EXCEPT ![(p)] = (ACK)]))) & (((fapply ((t), (''sigma''))) = ([ i \<in> (NodeSet)  \<mapsto> (cond((((fapply ((fapply ((told), (''sigma''))), (i))) = (fapply ((fapply ((told), (''sigma''))), (fapply ((fapply ((fapply ((told), (''arg''))), (p))), ((Succ[0])))))))), (fapply ((fapply ((told), (''sigma''))), (fapply ((fapply ((fapply ((told), (''arg''))), (p))), ((Succ[Succ[0]])))))), (fapply ((fapply ((told), (''sigma''))), (i)))))]))) & (((fapply ((t), (''op''))) = (fapply ((told), (''op''))))) & (((fapply ((t), (''arg''))) = (fapply ((told), (''arg'')))))) | ((((fapply ((fapply ((told), (''ret''))), (p))) = (ACK))) & (((fapply ((t), (''ret''))) = (fapply ((told), (''ret''))))) & (((fapply ((t), (''sigma''))) = (fapply ((told), (''sigma''))))) & (((fapply ((t), (''op''))) = (fapply ((told), (''op''))))) & (((fapply ((t), (''arg''))) = (fapply ((told), (''arg'')))))))))))) & ((((a_pchash_primea :: c)) = ([(pc) EXCEPT ![(p)] = (''U7'')]))) & (((((a_uunde_Fhash_primea :: c)) = (a_uunde_Fa))) & ((((a_aunde_Fhash_primea :: c)) = (a_aunde_Fa))) & ((((a_bunde_Fhash_primea :: c)) = (a_bunde_Fa))) & ((((a_uunde_Uhash_primea :: c)) = (a_uunde_Ua))) & ((((a_vunde_Uhash_primea :: c)) = (a_vunde_Ua))) & ((((a_aunde_Uhash_primea :: c)) = (a_aunde_Ua))) & ((((a_bunde_Uhash_primea :: c)) = (a_bunde_Ua))) & ((((a_chash_primea :: c)) = (a_ca))) & ((((a_dhash_primea :: c)) = (d))))) | (((((a_Fhash_primea :: c)) = ([(F) EXCEPT ![(fapply ((a_uunde_Ua), (p)))] = (((''parent'' :> (fapply ((a_vunde_Ua), (p)))) @@ (''rank'' :> (fapply ((fapply ((a_aunde_Ua), (p))), (''rank'')))) @@ (''bit'' :> ((Succ[0])))))]))) & ((((a_Mhash_primea :: c)) = (M))) & ((((a_pchash_primea :: c)) = ([(pc) EXCEPT ![(p)] = (''U7'')]))) & (((((a_uunde_Fhash_primea :: c)) = (a_uunde_Fa))) & ((((a_aunde_Fhash_primea :: c)) = (a_aunde_Fa))) & ((((a_bunde_Fhash_primea :: c)) = (a_bunde_Fa))) & ((((a_uunde_Uhash_primea :: c)) = (a_uunde_Ua))) & ((((a_vunde_Uhash_primea :: c)) = (a_vunde_Ua))) & ((((a_aunde_Uhash_primea :: c)) = (a_aunde_Ua))) & ((((a_bunde_Uhash_primea :: c)) = (a_bunde_Ua))) & ((((a_chash_primea :: c)) = (a_ca))) & ((((a_dhash_primea :: c)) = (d))))))"
assumes v'121: "((((a_Fhash_primea :: c)) = ([(F) EXCEPT ![(fapply ((a_uunde_Ua), (p)))] = (((''parent'' :> (fapply ((a_vunde_Ua), (p)))) @@ (''rank'' :> (fapply ((fapply ((a_aunde_Ua), (p))), (''rank'')))) @@ (''bit'' :> ((0)))))])))"
assumes v'122: "((((a_Mhash_primea :: c)) = (subsetOf(([''sigma'' : (StateSet), ''ret'' : ([(PROCESSES) \<rightarrow> (((((NodeSet) \<union> ({(BOT)}))) \<union> ({(ACK)})))]), ''op'' : (OpSet), ''arg'' : (ArgSet)]), %t. (\<exists> told \<in> (M) : (((((fapply ((fapply ((told), (''ret''))), (p))) = (BOT))) & (((fapply ((t), (''ret''))) = ([(fapply ((told), (''ret''))) EXCEPT ![(p)] = (ACK)]))) & (((fapply ((t), (''sigma''))) = ([ i \<in> (NodeSet)  \<mapsto> (cond((((fapply ((fapply ((told), (''sigma''))), (i))) = (fapply ((fapply ((told), (''sigma''))), (fapply ((fapply ((fapply ((told), (''arg''))), (p))), ((Succ[0])))))))), (fapply ((fapply ((told), (''sigma''))), (fapply ((fapply ((fapply ((told), (''arg''))), (p))), ((Succ[Succ[0]])))))), (fapply ((fapply ((told), (''sigma''))), (i)))))]))) & (((fapply ((t), (''op''))) = (fapply ((told), (''op''))))) & (((fapply ((t), (''arg''))) = (fapply ((told), (''arg'')))))) | ((((fapply ((fapply ((told), (''ret''))), (p))) = (ACK))) & (((fapply ((t), (''ret''))) = (fapply ((told), (''ret''))))) & (((fapply ((t), (''sigma''))) = (fapply ((told), (''sigma''))))) & (((fapply ((t), (''op''))) = (fapply ((told), (''op''))))) & (((fapply ((t), (''arg''))) = (fapply ((told), (''arg''))))))))))))"
assumes v'123: "((((a_pchash_primea :: c)) = ([(pc) EXCEPT ![(p)] = (''U7'')])))"
assumes v'124: "((((a_uunde_Fhash_primea :: c)) = (a_uunde_Fa)))"
assumes v'125: "((((a_aunde_Fhash_primea :: c)) = (a_aunde_Fa)))"
assumes v'126: "((((a_bunde_Fhash_primea :: c)) = (a_bunde_Fa)))"
assumes v'127: "((((a_uunde_Uhash_primea :: c)) = (a_uunde_Ua)))"
assumes v'128: "((((a_vunde_Uhash_primea :: c)) = (a_vunde_Ua)))"
assumes v'129: "((((a_aunde_Uhash_primea :: c)) = (a_aunde_Ua)))"
assumes v'130: "((((a_bunde_Uhash_primea :: c)) = (a_bunde_Ua)))"
assumes v'131: "((((a_chash_primea :: c)) = (a_ca)))"
assumes v'132: "((((a_dhash_primea :: c)) = (d)))"
fixes a_punde_1a
assumes a_punde_1a_in : "(a_punde_1a \<in> (PROCESSES))"
fixes t
assumes t_in : "(t \<in> ((a_Mhash_primea :: c)))"
assumes v'152: "(((fapply (((a_pchash_primea :: c)), (a_punde_1a))) = (''U6'')))"
fixes told
assumes told_in : "(told \<in> (M))"
assumes v'157: "(((((fapply ((fapply ((told), (''ret''))), (p))) = (BOT))) & (((fapply ((t), (''ret''))) = ([(fapply ((told), (''ret''))) EXCEPT ![(p)] = (ACK)]))) & (((fapply ((t), (''sigma''))) = ([ i \<in> (NodeSet)  \<mapsto> (cond((((fapply ((fapply ((told), (''sigma''))), (i))) = (fapply ((fapply ((told), (''sigma''))), (fapply ((fapply ((fapply ((told), (''arg''))), (p))), ((Succ[0])))))))), (fapply ((fapply ((told), (''sigma''))), (fapply ((fapply ((fapply ((told), (''arg''))), (p))), ((Succ[Succ[0]])))))), (fapply ((fapply ((told), (''sigma''))), (i)))))]))) & (((fapply ((t), (''op''))) = (fapply ((told), (''op''))))) & (((fapply ((t), (''arg''))) = (fapply ((told), (''arg'')))))) | ((((fapply ((fapply ((told), (''ret''))), (p))) = (ACK))) & (((fapply ((t), (''ret''))) = (fapply ((told), (''ret''))))) & (((fapply ((t), (''sigma''))) = (fapply ((told), (''sigma''))))) & (((fapply ((t), (''op''))) = (fapply ((told), (''op''))))) & (((fapply ((t), (''arg''))) = (fapply ((told), (''arg'')))))))"
assumes v'160: "(\<forall> i \<in> (NodeSet) : (\<forall> j \<in> (NodeSet) : ((((SameRoot ((told), (i), (j)))) \<Rightarrow> ((SameRoot ((t), (i), (j))))))))"
assumes v'161: "(((((((((((((((\<forall> p_1 \<in> (PROCESSES) : (\<forall> t_1 \<in> (M) : (((((fapply ((pc), (p_1))) = (''U6''))) \<Rightarrow> ((((fapply ((fapply ((t_1), (''ret''))), (p_1))) \<in> ({(BOT), (ACK)}))) & (((fapply ((fapply ((t_1), (''op''))), (p_1))) = (''U''))) & (((fapply ((fapply ((t_1), (''arg''))), (p_1))) \<in> (((NodeSet) \<times> (NodeSet))))) & ((InvU6All ((p_1), (t_1))))))))) \<and> (a_Validunde_ca))) \<and> (a_Validunde_uunde_Ua))) \<and> (a_Validunde_vunde_Ua))) \<and> (((M) \<in> ((SUBSET ([''sigma'' : (StateSet), ''ret'' : ([(PROCESSES) \<rightarrow> (((((NodeSet) \<union> ({(BOT)}))) \<union> ({(ACK)})))]), ''op'' : (OpSet), ''arg'' : (ArgSet)]))))))) \<and> (((pc) \<in> ([(PROCESSES) \<rightarrow> ({(''0''), (''F1''), (''F2''), (''F3''), (''F4''), (''F5''), (''F6''), (''F7''), (''FR''), (''U1''), (''U2''), (''U3''), (''U4''), (''U5''), (''U6''), (''U7''), (''U8''), (''UR''), (''F1U1''), (''F2U1''), (''F3U1''), (''F4U1''), (''F5U1''), (''F6U1''), (''F7U1''), (''F8U1''), (''FRU1''), (''F1U2''), (''F2U2''), (''F3U2''), (''F4U2''), (''F5U2''), (''F6U2''), (''F7U2''), (''F8U2''), (''FRU2''), (''F1U7''), (''F2U7''), (''F3U7''), (''F4U7''), (''F5U7''), (''F6U7''), (''F7U7''), (''F8U7''), (''FRU7''), (''F1U8''), (''F2U8''), (''F3U8''), (''F4U8''), (''F5U8''), (''F6U8''), (''F7U8''), (''F8U8''), (''FRU8'')})]))))) \<and> (a_Validunde_aunde_Ua))) \<and> (a_Validunde_bunde_Ua)))"
shows "(((((((((fapply ((fapply ((t), (''arg''))), (a_punde_1a))) \<in> (((NodeSet) \<times> (NodeSet))))) \<and> (((fapply ((fapply ((t), (''ret''))), (a_punde_1a))) = (fapply ((fapply ((told), (''ret''))), (a_punde_1a))))))) \<and> (((fapply ((fapply ((t), (''op''))), (a_punde_1a))) = (''U''))))) \<and> (((fapply ((fapply ((t), (''ret''))), (a_punde_1a))) \<in> ({(BOT), (ACK)})))))"(is "PROP ?ob'231")
proof -
show "PROP ?ob'231"
using assms by auto
qed
